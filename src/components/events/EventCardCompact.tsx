...
function formatEventMeta(start_time: string | null, business_name: string | null) {
...
export default function EventCardCompact({ event, onSelectEvent }: EventCardCompactProps) {
